...
public static class PropertyContextExtensions
{
        ...
        where T : class
    {
        ...
        ValidationContext<T, TProperty>? valCtx = new ValidationContext<T, TProperty>(ctx, options);
        validation(valCtx);
        ...
        where T : class, INotifyPropertyChanged
    {
        ...
        ValidationContext<T, TProperty>? valCtx = new ValidationContext<T, TProperty>(ctx, options);
        validation(valCtx);
        ValidationPropertyChangedContext<T, TProperty>? newCtx = new ValidationPropertyChangedContext<T, TProperty>(ctx);
        ...
        where T : class
    {
        ...
        IValidatable? instance = (IValidatable)ctx.Property.ClassInstance;
        if (result.IsValid)
        {
